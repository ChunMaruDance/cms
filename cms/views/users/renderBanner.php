      ...
      <div class="col-md-6 mb-3">
        <div class="card">
          <form action="/upload-banner-image" method="post" enctype="multipart/form-data">
            ...
            <label for="imageUpload" class="card-img-top" style="display: flex; align-items: center; justify-content: center; background-color: #f8f9fa; cursor: pointer;">
        ...
        <div class="col-md-6 mb-3">
          <div class="card">
            ...
            <div class="card-body d-flex flex-column justify-content-between">
              ...
              <form action="/delete-banner-image" method="post">
